...
//     try {
//       setLoader(true)
//       let currentGeoLocation = await fetch(`https://geocoding-api.open-meteo.com/v1/search?name=${city}`)
...
//       let fetchWeatherData = await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&current_weather=true&daily=temperature_2m_max,temperature_2m_min,precipitation_sum`)
//       let weatherResponseData = await fetchWeatherData.json();
//       console.log("from",weatherResponseData)
...
//      {weatherData && <ShowWeather weather={weatherData.current_weather} city={city} daily={weatherData.daily}/>}
//     </div>
//   );
// }
